...
Usage (host, conda activate qwen3-tts):
  python tests/tools/verify_e2e_trt_ref.py --variant design-1.7b --steps 50
  python tests/tools/verify_e2e_trt_ref.py --variant design-1.7b --steps 1000  # long sequence
"""
