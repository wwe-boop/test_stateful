...
Usage (host, conda activate qwen3-tts):
  python scripts/python/generate_audio_compare.py --variant design-1.7b
  python scripts/python/generate_audio_compare.py --variant design-1.7b --text "你好，世界" --max-steps 300
"""
        ...
        try:
            ...
            def _stream_cb(result, error):
                ...
                if chunk is not None and chunk.size > 0:
                    chunks.append(chunk.flatten().copy())
