...
Usage:
  ...
  python scripts/python/compare_official_vs_triton_audio.py --variant custom-1.7b \\
      --text "你好，这是一段测试。" --speaker serena --triton-url localhost:8001

  # VoiceDesign variant:
  python scripts/python/compare_official_vs_triton_audio.py --variant design-1.7b \\
